...
class Train:
    def __init__(self):
        ...
        self.data = input_data.read_data_sets("/home/sisi/work/dataset/MNIST-data", one_hot=True)
        ...
        for i in range(train_step):
            ...
            if (i + 1) % 10 == 0:
                accuracy = self.sess.run(self.net.accuracy,
                                 feed_dict={self.net.x: self.data.test.images, self.net.label: self.data.test.labels})
                print('第%5d步，当前loss：%.2f, acc=%.2f' % (i + 1, loss, accuracy))
